...
<head>
    ...
    <title>Gestion des Types de Produits</title>
...
<body>
    <div class="container">
        <h1 class="text-center">Gestion des Types de Produits</h1>
 
        <hr>

        <!-- Tableau pour afficher la liste des typeProduit -->
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                <%-- Récupération et affichage des typeProduit --%>
                <c:forEach var="lab" items="${typeProduit}">
                    <tr>
                        <td>${lab.id}</td>
                        <td>${lab.label}</td>
                        <td>
